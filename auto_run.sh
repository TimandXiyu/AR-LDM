...
distillation_weights=(0.1 0.5 1.0 1.5 2.0)
...
do
    ...
    sed -i "s/run_name: .*/run_name: flintstones_train_distill_$weight/" config.yaml
...
do
    ...
    sed -i "s|test_model_file: .*|test_model_file: \"./ckpts/flintstones_train_distill_$weight/epoch=99.ckpt\"|" config-test.yaml
